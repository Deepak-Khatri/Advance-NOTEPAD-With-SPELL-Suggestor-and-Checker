...
public class TheLastWord extends JFrame implements ActionListener,KeyListener,ListSelectionListener{


private int pos=0,pos2;
private String pop,s;
...
public TheLastWord() {
	...
	this.getContentPane().add(list).setBounds(710,60,123,228);
	
	this.label.setText("Suggestions [ Click on Word To Replace ]");
	...
	this.close.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F4,Event.ALT_MASK));
...
public static void main(String args[])  {
    TheLastWord app = new TheLastWord();
    try {
        // Set System L&F
	...
	// TODO Auto-generated method stub
        ...
        if(keyCode==KeyEvent.VK_SPACE||keyCode==KeyEvent.VK_ENTER){
            	        		...
            	        		st.push(input.substring(m.start(), m.end()));
									...
									int n=st.peek().length();
								    
									Highlighter highlighter = textArea.getHighlighter();
									HighlightPainter painter = 
									       new DefaultHighlighter.DefaultHighlightPainter(Color.yellow);
            	                    //highlighter.addHighlight(pos2, n, painter);
									
                                try {
                                	Process rtime = Runtime.getRuntime().exec("/home/god/workspace/notepadd/runcpp.sh "+st.peek());
                    				BufferedReader br = new BufferedReader(new InputStreamReader(rtime.getInputStream()));
            	...
            	/*else{
            		...
            		pos2=this.textArea.getCaretPosition();
                        ...
                        if((pos2-pos)>=3){
                        	try {
                        	Process rtime = Runtime.getRuntime().exec("/home/god/workspace/notepadd/runcpp.sh "+input);
            				BufferedReader br = new BufferedReader(new InputStreamReader(rtime.getInputStream()));
